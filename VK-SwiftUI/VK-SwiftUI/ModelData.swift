...
final class ModelData: ObservableObject {
    ...
    @Published var news: [News] = [ News(id: 0, ownerName: "Brad Pitt", date: "237790", ownerAvatar: "brad", text: "The first new", attachments: "brad", comments: 23, likes: 123, reposts: 2, views: 345),
                                    News(id: 1, ownerName: "Tom Cruise", date: "237790", ownerAvatar: "tom", text: "The second new", attachments: "tom", comments: 0, likes: 0, reposts: 0, views: 0),
                                    News(id: 2, ownerName: "Chess", date: "237790", ownerAvatar: "chess", text: "The third new", attachments: "chess", comments: 3, likes: 3, reposts: 0, views: 35)
    ]
